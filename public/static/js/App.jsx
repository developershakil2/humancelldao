...
import "./style.scss";
import { dailp, mim4, usdc4, dai4, dailp4, mim4_v2, usdc4_v2, dai4_v2, fraxlp4, usdclp4, gohmlp4 } from "./helpers/AllBonds";
...
function App() {
  ...
  let { bonds } = useBonds();
  bonds = bonds.concat([dailp, dailp4, usdc4, mim4, dai4, usdc4_v2, mim4_v2, dai4_v2, fraxlp4, usdclp4, gohmlp4]);
  // bonds = bonds.concat([dailp, usdc4, mim4, dai4]);
  ...
  useEffect(() => {
    ...
    if (shouldTriggerSafetyCheck()) {
      dispatch(info("Safety Check: Always verify you're on human cell dao!"));
    }
  }, []);
