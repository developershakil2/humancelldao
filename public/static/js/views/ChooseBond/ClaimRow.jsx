...
import { dailp, mim4, usdc4, dai4, dailp4, mim4_v2, usdc4_v2, dai4_v2, fraxlp4, usdclp4, gohmlp4, frax4 } from "src/helpers/AllBonds";

export function ClaimBondTableData({ userBond }) {
  const dispatch = useDispatch();
  let { bonds } = useBonds();
  bonds = bonds.concat([dailp, dailp4, usdc4, frax4, mim4, dai4, usdc4_v2, mim4_v2, dai4_v2, fraxlp4, usdclp4, gohmlp4]);
